...
const (
	...
	AllIncidentReportDeleted          = "All incident reports are deleted"
	AllIncidentReportDeletedFromRedis = "All incident reports are deleted from redis"
...
const (
	...
	FailedToDeleteDataInRedis         = "Failed to delete data in redis: %s"
	FailedToDeleteAllReportsFromRedis = "Failed to delete all reports from redis"
)
